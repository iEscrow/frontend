      ...
      <div className=" flex flex-col md:justify-between md:w-[60%]">
        ...
        <div className="md:pl-10 sm:pl-2 max-md:space-y-[-4px]">
          <div className="flex gap-5">
            <p className="text-dark-blue font-semibold text-lg">ENVÍA</p>
            <p className="text-lg">{send}</p>
          </div>
          <div className="flex gap-5">
            <p className="text-dark-blue font-semibold text-lg">PRECIO</p>
            <p className="text-lg">{price}</p>
          </div>
        </div>
        <div className="md:flex md:gap-4 max-md:pl-2 max-md:pb-2 gap-1">
          <p className="text-dark-blue font-semibold text-[10px]">Cerró precio con:</p>
        ...
        <div className="flex gap-4 md:hidden">
          <div className="md:flex md:gap-4 max-md:pl-2 gap-1">
            <p className="text-blue-2 text-[10px]">Cotización Dolar</p>
            <p className="md:text-sm sm:text-lg">$ 280,00</p>
          </div>
          <div className="md:flex md:gap-4 max-md:pl-2 gap-1">
            <p className="text-blue-2 text-[10px]">Método de pago</p>
