    ...
    <div className="w-full gap-y-10">
      ...
      <div className="text-white w-full flex items-center md:items-start flex-row">
        <div className="w-full md:w-[30%] text-center md:text-start">
          <p className="text-[24px] font-[300] leading-tight mb-4  md:text-[36px]">Intercambia tus activos de la forma mas segura</p>
        ...
        <div className="w-[50%] flex items-center md:items-start md:ml-14">
            <Image src={candado} className="w-[100px] md:w-[120px]" alt="candado"/>
        </div>
      </div>
      <div className="flex items-center md:items-start w-full">
        <button className="text-sm w-[100px] md:w-[130px] rounded-full mt-10 py-2 text-[18px] font-bold bg-green text-blue ">
            COMENZAR
        </button>
      </div>
    </div>
