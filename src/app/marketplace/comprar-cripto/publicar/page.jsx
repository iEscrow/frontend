...
export default function publicar() {
  return (
    <div className="flex flex-col sm:gap-6 md:gap-10">
      <div className="bg-blue-2 w-full flex sm:flex-col lg:flex-row lg:justify-center sm:gap-2 md:gap-4 lg:gap-10 py-4 sm:px-2 font-medium md:text-[18px] sm:text-sm text-white ">
        <div>
      ...
      <div className=" flex flex-col 4 gap-6 text-dark-blue dark:text-white">
        ...
        <div className="flex gap-1">
          ...
          <Link className="md:text-lg sm:text-sm underline text-blue-2 dark:text-light-blue " href="/">
            aquí.
          </Link>
        </div>
        <h3 className="md:text-lg sm:text-sm">
      ...
      <div className="flex md:gap-5 sm:gap-2 justify-center md:text-lg sm:text-xs md:font-semibold">
        <button className=" sm:btn-xs md:btn-md bg-blue-2 text-white rounded-full">
          MIS ESCROWS
        </button>
        <button className=" sm:btn-xs md:btn-md bg-blue-2 text-white  rounded-full">
          MARKETPLACE
