...
export default function Contraparte() {
  return (
    <Peticiion get={'0,07 BTC'} send={'$ 27.505,20 ARS'}>
      <h3 className="text-lg mb-4">Condiciones del escrow</h3>
      <div className="flex flex-col text-base gap-2">
        <h4 className="text-sm ml-5 text-light-blue">El precio del Bitcoin se ha cerrado con</h4>
        ...
        <h3 className="ml-5">$AR 205,05</h3>
        <hr className="border border-[#2E75A9] w-full mb-28" />
      </div>
    </Peticiion>
  );
}
