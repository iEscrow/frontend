          ...
          <section className="flex flex-col gap-5 md:w-[40vw]">
              ...
              <div className="flex gap-5">
                ...
                <div className="pl-5">
                  ...
                  <p className="text-red">
                    <span className="text-light-blue">Calificación </span>Negativa
                  </p>
            ...
            >
              REPLICAR
                ...
                <p className="text-yellow">Hubo un reclamo abierto por NOMBRE USUARIO, que no pudo ser resuelto por el usuario</p>
              </div>
              <div className="divider" />
            </section>
        </div>
